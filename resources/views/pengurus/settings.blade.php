    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white p-6 rounded-xl shadow-lg">
                ...
                <form action="{{ route('pengurus.settings.profile.update') }}" method="POST">
                    @csrf
        ...
        <div class="lg:col-span-1 space-y-8">
            <div class="bg-white p-6 rounded-xl shadow-lg">
                ...
                <form action="{{ route('pengurus.settings.password.update') }}" method="POST" class="space-y-4">
                    @csrf
                    <div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border-2 border-red-300">
                ...
                @enderror
                <form action="{{ route('pengurus.settings.account.delete') }}" method="POST" onsubmit="return confirm('PERINGATAN! Apakah Anda benar-benar yakin ingin menghapus akun Anda? Tindakan ini bersifat permanen dan tidak dapat diurungkan.');">
                    @csrf
                    @method('DELETE')
                    <div class="mb-4">
